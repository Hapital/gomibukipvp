# まずはランダム
execute store result score @s lib.random run random value 1..600
...
execute if score @s lib.random matches 501..600 run function lib:items/give/16_fire_pattern_pod